...
},{"../util":61}],6:[function(require,module,exports){
var _ = require('../util')
...
},{"../parse/directive":49,"../parse/expression":50,"../parse/path":51,"../parse/text":53,"../util":61,"../watcher":65}],7:[function(require,module,exports){
var _ = require('../util')
...
},{"../transition":55,"../util":61}],8:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":61}],9:[function(require,module,exports){
var _ = require('../util')
...
},{"../config":16,"../util":61,"../util/merge-option":63}],10:[function(require,module,exports){
var _ = require('../util')
...
},{"../compile/compile":14,"../util":61}],11:[function(require,module,exports){
var _ = require('./util')
...
},{"../config":16,"../parse/directive":49,"../parse/template":52,"../parse/text":53,"../util":61}],15:[function(require,module,exports){
var _ = require('../util')
var templateParser = require('../parse/template')
...
},{"../parse/template":52,"../util":61}],16:[function(require,module,exports){
module.exports = {
...
},{"./config":16,"./parse/expression":50,"./parse/text":53,"./util":61,"./watcher":65}],18:[function(require,module,exports){
// xlink
...
},{"../parse/template":52,"../util":61}],22:[function(require,module,exports){
module.exports = {
...
},{"../parse/template":52,"../util":61}],24:[function(require,module,exports){
var _ = require('../util')
var compile = require('../compile/compile')
var templateParser = require('../parse/template')
var transition = require('../transition')
...
},{"../compile/compile":14,"../parse/template":52,"../transition":55,"../util":61}],25:[function(require,module,exports){
...
},{"./attr":18,"./class":19,"./cloak":20,"./component":21,"./el":22,"./html":23,"./if":24,"./model":28,"./on":31,"./partial":32,"./ref":33,"./repeat":34,"./show":35,"./style":36,"./text":37,"./transition":38,"./with":39}],26:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../util":61}],28:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../util":61,"./checkbox":26,"./default":27,"./radio":29,"./select":30}],29:[function(require,module,exports){
var _ = require('../../util')
...
},{"../../util":61}],30:[function(require,module,exports){
var _ = require('../../util')
var Watcher = require('../../watcher')
...
},{"../../util":61,"../../watcher":65}],31:[function(require,module,exports){
var _ = require('../util')
...
},{"../parse/template":52,"../transition":55,"../util":61}],33:[function(require,module,exports){
var _ = require('../util')
...
},{"../compile/compile":14,"../compile/transclude":15,"../parse/expression":50,"../parse/template":52,"../parse/text":53,"../util":61,"../util/merge-option":63}],35:[function(require,module,exports){
var transition = require('../transition')
...
},{"../transition":55}],36:[function(require,module,exports){
...
},{"../util":61,"../watcher":65}],40:[function(require,module,exports){
var _ = require('../util')
var Path = require('../parse/path')
...
},{"../parse/path":51,"../util":61}],41:[function(require,module,exports){
var _ = require('../util')
...
},{"../util":61,"./array-filters":40}],42:[function(require,module,exports){
var _ = require('../util')
...
},{"../compile/compile":14,"../compile/transclude":15,"../directive":17,"../util":61}],43:[function(require,module,exports){
var _ = require('../util')
var inDoc = _.inDoc
...
},{"../util/merge-option":63}],45:[function(require,module,exports){
var _ = require('../util')
...
},{"../binding":12,"../observer":47,"../util":61}],46:[function(require,module,exports){
var _ = require('../util')
...
},{"../binding":12,"../config":16,"../util":61,"./array":46,"./object":48}],48:[function(require,module,exports){
var _ = require('../util')
...
},{"../cache":13,"../util":61}],50:[function(require,module,exports){
var _ = require('../util')
...
},{"../cache":13,"../util":61,"./path":51}],51:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":13,"../util":61}],52:[function(require,module,exports){
var _ = require('../util')
var Cache = require('../cache')
...
},{"../cache":13,"../util":61}],53:[function(require,module,exports){
var Cache = require('../cache')
var config = require('../config')
...
},{"../cache":13,"../config":16,"./directive":49}],54:[function(require,module,exports){
var _ = require('../util')
var addClass = _.addClass
var removeClass = _.removeClass
...
},{"../config":16}],58:[function(require,module,exports){
var config = require('../config')
...
},{"../config":16}],59:[function(require,module,exports){
/**
...
},{"./api/child":5,"./api/data":6,"./api/dom":7,"./api/events":8,"./api/global":9,"./api/lifecycle":10,"./directives":25,"./filters":41,"./instance/compile":42,"./instance/events":43,"./instance/init":44,"./instance/scope":45,"./util":61}],65:[function(require,module,exports){
var _ = require('./util')
var config = require('./config')
var Observer = require('./observer')
var expParser = require('./parse/expression')
...
},{"./batcher":11,"./config":16,"./observer":47,"./parse/expression":50,"./util":61}],66:[function(require,module,exports){
module.exports = '';
},{}],67:[function(require,module,exports){
module.exports = '<h2>Keep. Power By Vue.js .</h2>\n<div v-component="a"></div>\n\n<div v-component="product"></div>';
...
},{"./style.css":69,"./template.html":70,"insert-css":1}],69:[function(require,module,exports){
...
},{"./style.css":72,"./template.html":73,"insert-css":1,"superagent":2,"vue":64}],72:[function(require,module,exports){
module.exports = '\n.items{\n	\n}\n.items li label{\n	cursor: pointer;\n}\n.items li.sold-out{\n	text-decoration: line-through;\n	color: #9A9A9A;\n}\n.hide{\n	display: none;\n}\n.highlight{\n	color: #5BC0DE;\n}\n\n.phone-list li, .type-list li{\n	cursor: pointer;\n	float: left;\n	margin-right: 20px;\n}\n.phone-list, .type-list{\n	overflow: hidden;\n}\n\n\n\n';
},{}],73:[function(require,module,exports){
module.exports = '<div>\n	<h2>{{title}}</h2>\n    <ul class="items">\n    	<li class="{{stock > 0 ? \'\': \'sold-out\' }}"\n    		v-repeat="items">\n    		<label>\n    			{{$index+1}}, {{name}} / {{stock}}\n    			<input class="{{stock > 0 ? \'\' : \'hide\'}}" \n    				   type="radio" \n    				   name="phone" \n    				   value="{{name}}" \n    				   v-model="selected" />\n    		</label>	\n    	</li>\n    </ul>\n    <p>\n    	已选产品：\n    	<span class="highlight">\n    		{{selected ? selected : \'未选择\' }}\n    	</span>\n    </p>\n    <div>\n    	<button type="button"\n	    		v-on="click: clickHandler(this)">\n	    	获取手机产品信息\n    	</button>\n    	<h2>手机产品：</h2>\n    	<ul class="phone-list">\n    		<li v-repeat="phone: phones" v-on="click: phoneHandler(phone)">\n    			{{phone.name}}\n    			<img v-attr="src: phone.pic" style="vertical-align: middle;" width="100" height="100" />\n    		</li>\n    	</ul>\n    	<h2>制式：</h2>\n    	<ul class="type-list">\n    		<li v-repeat="type: types" v-on="click: typeHandler(type)">\n    			{{type.name}}\n    		</li>\n    	</ul>\n    	<h2>颜色：</h2>\n    	<ul class="color-list">\n    		<li v-repeat="color: colors" v-on="click: colorHandler(color)">\n    			{{color.name}}\n    		</li>\n    	</ul>\n    	<h2>自定义组件：</h2>\n    	<div v-component="seven-modal"></div>\n    </div>\n</div>';
...
},{"./app.css":66,"./app.html":67,"./component-a":68,"./component-product":71,"insert-css":1,"vue":64}]},{},[74]);
